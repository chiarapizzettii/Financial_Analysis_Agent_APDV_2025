...
# OUTPUT_PARQUET_PATH = "./processed.parquet"  # Uncomment if you want Parquet
...
# -----------------------------
# 4. WRITE TO CSV (or Parquet)
# -----------------------------

df.write_csv(OUTPUT_CSV_PATH)
# df.write_parquet(OUTPUT_PARQUET_PATH)  # Uncomment if you want Parquet
