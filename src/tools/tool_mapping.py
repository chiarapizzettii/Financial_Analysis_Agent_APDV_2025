...
TOOL_REGISTRY: Dict[str, ToolMetadata] = {
    ...
    "generate_report": ToolMetadata(
        ...
        function=generate_report_from_state,
        category=ToolCategory.VIZ_CORRELATION,  # We can reuse this or create REPORTING category
        description="Generate a comprehensive PDF report from analysis results",
        required_params=["state"],
        optional_params=["user_query", "output_dir", "custom_filename"],
        returns="Path to generated PDF file",
        example_usage='generate_report_from_state(state, user_query="Show revenue trends")',
        validation_requirements=[
            "State must be an ExecutionState object",
